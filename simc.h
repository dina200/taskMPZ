...
class array{
    ...
    //friend ostream& operator<<(ostream& os,array<min,max,char> a);
    };
...
extern array<1,evemax,bool> waitevent;
extern array<1,evemax,int> maxevent;
...
extern array<min_signal,max_signal,plistt> signlist;
extern array<1,evemax,plistt> ass, waitl;
